        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-12 relative">
          <div className="flex flex-col gap-6 max-w-xl">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-heading leading-none text-[#161616]">
              ...
              <span className="inline-block ml-2 align-super">
          ...
          <div className="flex items-center gap-8 md:gap-12 pb-2">
            <p className="text-sm text-[#555555] leading-relaxed max-w-[260px]">
            ...
            <div className="hidden lg:flex relative items-center justify-center w-28 h-28 shrink-0">
              <div
                ref={badgeRef}
                className="absolute inset-0 flex items-center justify-center origin-center"
              >
                 <svg viewBox="0 0 100 100" className="w-full h-full text-[#161616] fill-current origin-center">
                   <path id="circlePathProcess" d="M 50, 50 m -37, 0 a 37,37 0 1,1 74,0 a 37,37 0 1,1 -74,0" fill="none" />
                   <text className="text-[10px] font-bold tracking-[0.2em] uppercase">
                     <textPath href="#circlePathProcess" startOffset="0%">
